...
class User(UserMixin, db.Model):
    ...
    #   one to many relationship with BlogPost table
    ...
    #   one to many relationship with comment table
    details = relationship("ContactDetails", back_populates="users_details")
...
class ContactDetails(db.Model):
    ...
    # one to many relationship with user table
    author_id: Mapped[int] = mapped_column(Integer, db.ForeignKey("users.id"))
    users_details = relationship("User", back_populates="details")
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            flash("You have to be register for using this feature")
...
def contact():
    ...
    if request.method == "POST":
        ...
        if current_user.is_authenticated:
            ...
            return redirect(url_for('contact', message=True))
        else:
            flash("you are not logged in register instead")
            return redirect(url_for('register'))
